#pragma checksum "E:\gitprojects\localplayflix\mov\menu\MainPage.xaml" "{406ea660-64cf-4c82-b6f0-42d48172a799}" "AF00EA02ADFBE5CA972CAA18725AAECA"
//------------------------------------------------------------------------------
// <auto-generated>
...
namespace menu
{
        ...
        global::Windows.UI.Xaml.Markup.IComponentConnector2
    {
        ...
        private class MainPage_obj4_Bindings :
            ...
            IMainPage_Bindings
        {
            private global::Binding.Movie dataRoot;
            ...
            {
                 global::Binding.Movie data = args.NewValue as global::Binding.Movie;
                 if (args.NewValue != null && data == null)
                 {
                    throw new global::System.ArgumentException("Incorrect type passed into template. Based on the x:DataType global::Binding.Movie was expected.");
                 }
            ...
            public int ProcessBindings(global::Windows.UI.Xaml.Controls.ContainerContentChangingEventArgs args)
            {
                ...
                switch(args.Phase)
                {
                    case 0:
                        nextPhase = -1;
                        this.SetDataRoot(args.Item as global::Binding.Movie);
                ...
                this.Update_((global::Binding.Movie) args.Item, 1 << (int)args.Phase);
                return nextPhase;
            }
            ...
            public void SetDataRoot(global::Binding.Movie newDataRoot)
            {
                this.dataRoot = newDataRoot;
            }

            // Update methods for each path node used in binding steps.
            private void Update_(global::Binding.Movie obj, int phase)
            {
                if (obj != null)
                {
        ...
        private class MainPage_obj1_Bindings :
            ...
            IMainPage_Bindings
        {
            private global::menu.MainPage dataRoot;
            private bool initialized = false;
            private const int NOT_PHASED = (1 << 31);
            private const int DATA_CHANGED = (1 << 30);
            ...
            public void SetDataRoot(global::menu.MainPage newDataRoot)
            {
                this.dataRoot = newDataRoot;
            }
            ...
            // Update methods for each path node used in binding steps.
            private void Update_(global::menu.MainPage obj, int phase)
            {
                if (obj != null)
                {
                    if ((phase & (NOT_PHASED | (1 << 0))) != 0)
            ...
            private void Update_movies(global::System.Collections.Generic.List<global::Binding.Movie> obj, int phase)
            {
                if((phase & ((1 << 0) | NOT_PHASED )) != 0)
                {
            ...
            case 4:
                {
                    ...
                    returnValue = bindings;
                    bindings.SetDataRoot((global::Binding.Movie) element4.DataContext);
